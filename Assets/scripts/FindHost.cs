...
namespace UnityEngine.Networking
{
    ...
    public struct NetworkBroadcastRes
    {
        /// <summary>
    ...
    public class FindHost : MonoBehaviour
    {
        ...
        Dictionary<string, NetworkBroadcastRes> m_BroadcastsReceived;
        ...
        /// <para>The key is the server address, and the value is a NetworkBroadcastRes object that contains the data sent by the server.</para>
        /// </summary>
        public Dictionary<string, NetworkBroadcastRes> broadcastsReceived
        {
        ...
        public bool Initialize()
        {
            ...
            m_BroadcastsReceived = new Dictionary<string, NetworkBroadcastRes>();
        ...
        void Update()
        {
            ...
            do
            {
                ...
                if (networkEvent == NetworkEventType.BroadcastEvent)
                {
                    ...
                    var recv = new NetworkBroadcastRes();
        ...
        void OnGUI()
        {
            ...
            */
            //Debug.Log("recieving");
            //Debug.Log(m_BroadcastsReceived);
